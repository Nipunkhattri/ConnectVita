...
import { fetchexp, getdata } from '../redux/features/AuthSlice';
const Profile = () => {
      ...
      <div className='hei w-full rounded-xl bg-white'>
        ...
        {/* <div className='h-40 top-32 left-10 w-40 rounded-full border-solid border-2 imgp  relative'>
         ...
         <div className='h-40 top-32 left-10 w-40 rounded-full border-solid border-2 imgp1  relative'>
          <img src={add} className='h-20 cursor-pointer imagge' alt="" />
        </div>
        </div>
      ...
      </div>
{
  ...
  <div className=' mt-5 w-full bg-white'>
      ...
      <div  className='mb-5 w-full pl-9 pt-4'>
        <h1 className='text-xl font-medium'>Spam Checker ( Backend )</h1>
        <h3 className='text-slate-400 mb-4'>Mar 2023 - Mar 2023</h3>
        <button className='h-10 rounded-md mb-4 w-40 border-2 border-black'>Show Project</button>
        <p className='text-md w-10/12'>Lorem ipsum dolor sit am et consectetur adipisicing elit. Fugit blanditiis harum optio. Tempore illo esse impedit, at sapiente omnis excepturi!</p>
      </div>
      <ul className='w-10/12 ml-10 h-1 bg-slate-200'></ul>
      <div  className='mb-5 w-full pl-9 pt-4'>
        <h1 className='text-xl font-medium'>Spam Checker ( Backend )</h1>
