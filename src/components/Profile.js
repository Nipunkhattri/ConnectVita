      ...
      {my ? (
        <>
            ...
            {result?.headline != undefined ? (
              <div className="h-2/4 w-full flex">
                <div className="h-full w-3/5 pt-14 pl-10 ">
                  ...
                  <p className="mt-1">{result?.headline ? result?.headline : ""}</p>
          ...
          {result?.About != undefined ? (
            <div className="h-44 w-full mt-5 pt-6 pl-10 bg-white">
              <AiOutlineEdit
          ...
          {post ? (
            <div className=" mt-5 w-full bg-white">
              ...
              {filteredPosts?.map((item, index) => {
                return (
                  <>
                    <div className="h-36 ml-10 w-full mt-4 " key={index}>
...
out to next Level!..</p>
            ...
            <>
              <div className=" mt-5 w-full bg-white">
                <div className="h-30 w-full  flex">
                  <h1 className="text-2xl pl-9 pt-3 font-semibold">
                    Experience
                  </h1>
                  <AiFillFileAdd
 ...
 name="textarea" value={adata.textarea} onChange={handlechange01}></textarea>
        ...
        <button className="h-10 w-36 m-1 rounded-md bg-blue-400 float-right" onClick={savedata1}>Save</button>
        {/* </div> */}
      </div>
            </div>
            :<></>
